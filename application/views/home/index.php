    ...
    <div class="container-fluid ml-3">
      ...
      <?php foreach ($kontrakan as $kntrk) : ?>
        ...
        <div class="card mb-3 me-md-3 shadow" style="max-width: 540px;">
          <div class="row">
            <div class="col-md-4">
            <img src="<?php echo base_url(). '/assets/img/'.$kntrk->gambar?>" class="card-img-top mt-2">
            <figcaption class="mt-3 figure-caption text-center"><?php echo $kntrk->tipe ?></figcaption>
            </div>
            <div class="col-md-6">
              <div class="card-body">
                ...
                <?php echo anchor('home/detail/' .$kntrk->id_kontrakan, '<button type="button" class="btn btn-outline-info"><i class="fas fa-info"></i> Detail</button>') ?>
              </div>
            </div>
          </div>
        </div>
