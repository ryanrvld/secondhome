                    ...
                    <div class="col-md-8">
                        <table class="table table-borderless text-white">
                          ...
                          <tr>
                            ...
                            <a class="btn btn-success disabled" href="https://api.whatsapp.com/send?phone=6285155296783&text=Permisi" role="button"><i class="fab fa-whatsapp"></i> Hubungi Pemilik</a>
                             Silahkan Login Untuk Menghubungi pemilik
                          </div>
                          </tr>
                        ...
                        <a class="btn btn-light" href="<?=base_url()?>" role="button">Kembali</a>
                    </div>
                </div>
            </div>
            <!-- end detail -->
